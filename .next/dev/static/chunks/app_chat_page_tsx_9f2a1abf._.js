...
function ChatPage() {
    _s();
    const { messages, input, handleInputChange, sendMessage, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$react$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChat"])({
        api: '/api/chat'
    });
...
_s(ChatPage, "IqnewmvDtA5kNjj6kCUpGoYh0iU=", false, function() {
    return [
